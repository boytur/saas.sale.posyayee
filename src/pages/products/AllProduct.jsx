...
function AllProduct ({ pageState, setPageState }) {
        ...
        <div className='md:flex justify-between  rounded-t-lg bg-white'>
          <div className='md:flex my-6 items-center mx-2'>
            ...
            <div className='flex flex-col md:mr-2'>
              ...
              <select
                name=''
                className='md:w-[8rem] w-full input-primary cursor-pointer'
                id=''
              >
          ...
          <table className='w-full border-collapse'>
            ...
            <tbody className='bg-white'>
              {pageState?.data?.map((product, index) => (
                <tr
                  key={index}
                  className='hover:bg-[#f5f5ff] border-b-[1px] text-center cursor-pointer'
                >
                    ...
                    <div className='flex justify-center items-center z-0'>
                      {product.prod_barcode !== '' ? (
                        <Barcode
                          ...
                          value={product.prod_barcode.toString()}
                        />
                      ) : (
                  ...
                  <td className='px-3 py-1'>
                    <div className='toggle-switch'>
                      <input
                        ...
                        checked={product?.prod_status === 'active'}
                      />
                      <label
                  ...
                  <td className='px-3 text-lg py-1'>
                    {product.prod_quantity} ({product?.product_unit?.unit_name})
                  </td>
                  <td className='px-3 text-sm py-1'>
                    {formatUTCtoThai(product?.createdAt)}
                  </td>
                  <td className='px-3 py-1 '>
